...
import { ArrowUpRight, ExternalLink, Shield, Zap, Layout, Globe, ShoppingBag, LucideIcon } from 'lucide-react';
...
const projects: Project[] = [
  ...
  {
    title: 'OPSC Portal',
    description: 'Government platform for managing recruitment concurrence workflows, compliance, and multi-department coordination.',
    tags: ['PHP', 'System Design', 'Security'],
    icon: Shield,
    image: '/images/opsc.png',
    link: 'https://www.concurrence.opsc.gov.in/'
  },
  {
    title: 'MyShopIndia',
    description: 'Modern e-commerce platform facilitating seamless online shopping, order management, and secure payments.',
    tags: ['E-Commerce', 'React', 'Tailwind'],
    icon: ShoppingBag,
    image: '/images/myshop.png',
    link: 'https://myshopindia.in/'
  }
];

export default function Projects() {
  return (
    <section id="projects" className="relative z-20 pt-16 pb-8 md:pb-16 px-6 md:px-24 bg-[#0A0A0F]">
